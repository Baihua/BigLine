...
public:
	...
	BVHAccel* bvh;
	void buildBVH();
	Vector3f castRay(const Ray& ray, int depth, bool isPerfectSpecular = false) const;
	Vector3f castRay2(const Ray& ray, int depth, bool isPerfectSpecular = false) const;
	Vector3f castRayDir_InDir(const Ray& ray, int depth, bool isPerfectSpecular) const;
